...
export default function TransitionsModal({txt_livecast, movieWatchStatus, txt_movie, genre, inr, dollar, screenshot1, screenshot2, screenshot3, screenshot4, modal, num_movie_id, txt_movie_title, id, num_movie_price_inr, category, duration, children, language, media_type, movie_id, title, banner1, banner2, rating, synopsis, trailer1, trailer2, producer, director }) {
  ...
  const fetchData = async () => {
    await axios.get('www.api3.digimovieplex.com/api/get_Home_allMoviedetails', { id: movie_id }).then((res) => {
              ...
              <div className="ContentModal">
                ...
                <Carousel autoPlay >
                  {
                    propsArrayTwo && propsArrayTwo.map((value)=>{
                      return(
                              <img src={`www.api3.digimovieplex.com/${value}`}
                                  alt={title || title}
                ...
                <div className="ContentModal__about">
                  ...
                  <div className="modal_button">
                    ...
                    color="secondary">
                    <Link to={`/trailer/${encodeURIComponent(trailer1)}/${encodeURIComponent(rating)}`}>Trailer 1</Link>
                  </Button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <Button variant="contained"
                        className="trailer_two"
                          startIcon={<BookIcon />}
                          color="secondary" >
                            <Link to={`/read_more/${encodeURIComponent(JSON.stringify({ mid: movie_id,mpic:banner1,mgenre:genre,mlanguage:language,mmin:duration, mtitle: title, mprice: inr, mcat: category }))}`}>Read More</Link>
