...
const loginWithOtp = async (title, id, pId, lId) => {
    ...
    if (sessionStorage.getItem('auth')) {
        ...
        axios.post('www.api3.digimovieplex.com/api/otp_sent', data).then((res) => {
...
export default function ProducerLaunch() {
    ...
    useEffect(() => {
        if (sessionStorage.getItem('auth')) {
            ...
            fetch("www.api3.digimovieplex.com/api/get_Producer_live_castBy_Id", {
                method: 'POST',
    ...
    const submitHandler = (e) => {
        ...
        if (sessionStorage.getItem('auth')) {
            ...
            axios.post('www.api3.digimovieplex.com/api/add_Producer_Live_Cast', data).then((res) => {
                if (res.data.status === 'success') {
                    swal({
