...
const Login = ({ close, login, getUserState }) => {
      ...
      preConfirm: (mobile) => {
        if (mobile) {
          ...
          if (mobilePattern.test(mobile)) {
            ...
            return fetch(`www.api3.digimovieplex.com/api/otp_sent/`, {
              method: 'POST',
          ...
          preConfirm: (otpInput) => {
            if (otpInput) {
              if (otp === parseInt(otpInput)) {
                ...
                return fetch(`www.api3.digimovieplex.com/api/otp_check/`, {
                  method: 'POST',
                  body: JSON.stringify(data),
                  headers: {
                    "Content-Type": 'application/json',
      ...
      preConfirm: (email) => {
        if (email) {
          ...
          if (emailRegx.test(email)) {
            ...
            return fetch(`www.api3.digimovieplex.com/api/forgot_password_link`, {
              method: 'POST',
              body: JSON.stringify(data),
              headers: {
                "Content-Type": 'application/json',
  ...
  const responseGoogle = async (response) => {
    // console.log("abhiabhiabhi",response.profileObj.email);
    let googleResponse = {
    ...
    await fetch("www.api3.digimovieplex.com/api/google_login", {
      method: 'POST',
  ...
  useEffect(() => {
    axios.get('www.api3.digimovieplex.com/api/user_type_list').then(res => {
  ...
  async function signUp(e) {
    ...
    if (producerPhoneValidation()) {
      // let result = await fetch("www.api3.digimovieplex.com/api/user_signup", {
      //   method: 'POST',
      ...
      axios.post('www.api3.digimovieplex.com/api/user_signup', item).then((res) => {
  ...
  async function signIn(e) {
    ...
    if (item.username !== '' && item.password !== '') {
      let result = await fetch("www.api3.digimovieplex.com/api/user_signin", {
        method: 'POST',
        body: JSON.stringify(item),
        headers: {
          "Content-Type": 'application/json',
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          <GoogleLogin className="google_login"
             clientId="41630675457-5gkseaa88l535idg5kcn5mgv2jmeogjh.apps.googleusercontent.com"
            buttonText="LOG IN"
