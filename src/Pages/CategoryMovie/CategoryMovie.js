...
const Movies = () => {
    ...
    const getMovieByCategoryId = async () => {
        await axios.post(`www.api3.digimovieplex.com/api/getHomeMovieDetailsByCategory`, { id: atob(id) }).then((res) => {
    ...
    const fetchSearch = async () => {
        ...
        axios.post('www.api3.digimovieplex.com/api/getHomeMovieDetailsByCategoryIdandText',{movie_title :searchText,id: atob(id)}).then((resp)=>{
