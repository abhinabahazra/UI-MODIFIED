...
class TicketPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            surl: 'www.api3.digimovieplex.com/response',
            furl: 'www.api3.digimovieplex.com/response',
            hash: '',
            name:'',
            email:'',
            phone:'',
    ...
    getMovieFromWallet = async () => {
        if (sessionStorage.getItem('auth')) {
            ...
            await axios.post('www.api3.digimovieplex.com/api/insert_transactionByWallet', data).then((res) => {
                console.log(res);
                if (res.data.status === 'success') {
                    swal({
                        title: "Success",
        ...
        if (sessionStorage.getItem('auth')) {
            ...
            console.log("suvayan",num_user_id)
             this.setState({
                ...
                axios.post('www.api3.digimovieplex.com/hash',data).then((res)=>{
                    this.setState({
                        hash: res.data.hash
                    },()=>{
