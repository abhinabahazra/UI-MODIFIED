...
export class FourthForm extends Component {
    ...
    addMovieCast = async (e) => {
        ...
        await axios.post('www.api3.digimovieplex.com/api/add_movie_cast/', movieCast).then((res) => {
    ...
    async componentDidMount() {
        if(localStorage.getItem('movie_id')){
            ...
            await axios.post('www.api3.digimovieplex.com/api/getMovieCastDetails',{movie_id}).then((res) => {
