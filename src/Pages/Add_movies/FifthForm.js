...
export class FifthForm extends Component {
    ...
    onClickSubmit = async (e) =>{
        ...
        await axios.post('www.api3.digimovieplex.com/api/add_movie_player/',playerData).then((resp) => {
            //console.log(resp.data.status);
            if(resp.data.status === 'success'){
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer1/',fd1);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer2/',fd2);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer3/',fd3);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer4/',fd4);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer5/',fd5);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer6/',fd6);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer7/',fd7);
                axios.post('www.api3.digimovieplex.com/api/upload_ImagePlayer8/',fd8);
    ...
    async componentDidMount() {
        if(localStorage.getItem('movie_id')){
            ...
            await axios.post('www.api3.digimovieplex.com/api/getMoviePlayerDetails/',{movie_id}).then((res) => {
                ...
                if(res.data.status === 'success'){
                    ...
                    if(res.data.response.txt_player1_image !== '' && res.data.response.txt_player1_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file1 : `www.api3.digimovieplex.com/${res.data.response.txt_player1_image}`},
                    ...
                    if(res.data.response.txt_player2_image !== '' && res.data.response.txt_player2_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file2 : `www.api3.digimovieplex.com/${res.data.response.txt_player2_image}`},
                    ...
                    if(res.data.response.txt_player3_image !== '' && res.data.response.txt_player3_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file3 : `www.api3.digimovieplex.com/${res.data.response.txt_player3_image}`},
                    ...
                    if(res.data.response.txt_player4_image !== '' && res.data.response.txt_player4_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file4 : `www.api3.digimovieplex.com/${res.data.response.txt_player4_image}`},
                    ...
                    if(res.data.response.txt_player5_image !== '' && res.data.response.txt_player5_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file5 : `www.api3.digimovieplex.com/${res.data.response.txt_player5_image}`},
                    ...
                    if(res.data.response.txt_player6_image !== '' && res.data.response.txt_player6_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file6 : `www.api3.digimovieplex.com/${res.data.response.txt_player6_image}`},
                    ...
                    if(res.data.response.txt_player7_image !== '' && res.data.response.txt_player7_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file7 : `www.api3.digimovieplex.com/${res.data.response.txt_player7_image}`},
                    ...
                    if(res.data.response.txt_player8_image !== '' && res.data.response.txt_player8_image !== 'undefined'){
                        this.setState({
                            actorInfo : {...this.state.actorInfo, file8 : `www.api3.digimovieplex.com/${res.data.response.txt_player8_image}`},
