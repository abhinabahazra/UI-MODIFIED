...
export class SixthForm extends Component {
    ...
    onSubmitHandler = async (e) => {
        ...
        await axios.post('www.api3.digimovieplex.com/api/upload_banner1', banner_one).then((response) => {
                    ...
                    if(resTrailer1.status === "success"){
                        this.videoUpload('movie').then((resMovie) => {
                            if(resMovie.status === "success"){
                                axios.post('www.api3.digimovieplex.com/api/upload_banner2', banner_two);
                                axios.post('www.api3.digimovieplex.com/api/upload_screenshot1', screenshot_one);
                                axios.post('www.api3.digimovieplex.com/api/upload_screenshot2', screenshot_two);
                                axios.post('www.api3.digimovieplex.com/api/upload_screenshot3', screenshot_three);
                                axios.post('www.api3.digimovieplex.com/api/upload_screenshot4', screenshot_four);
    ...
    videoUpload = async(fname) => {
        ...
        // let start_upload = await axios.get(`www.api3.digimovieplex.com/start-upload`, {params}).then((resp)=>{
        //     let { uploadId } = resp.data
        //     this.setState({ uploadId : uploadId})
        // })
        let start_upload = await axios.get(`www.api3.digimovieplex.com/start-upload`, {params})
    ...
    async uploadMultipartFile(fname) {
        try {
          ...
          for (let index = 1; index < CHUNKS_COUNT + 1; index++) {
            ...
            let getUploadUrlResp = await axios.get(`www.api3.digimovieplex.com/get-upload-url`, {
              params: {
          ...
          let completeUploadResp = await axios.post(`www.api3.digimovieplex.com/complete-upload`, {
            params: {
              num_movie_id : localStorage.getItem('movie_id'),
              col_name: `txt_${fname}`,
              fileName: this.state.fileNameData[fname],
    ...
    async componentDidMount() {
        if (localStorage.getItem('movie_id')) {
            ...
            await axios.post('www.api3.digimovieplex.com/api/getMovieLinkDetails', { movie_id }).then((res) => {
                //console.log(res);
                if (res.data.status === 'success') {
                    if (res.data.response.txt_banner1 !== '' && res.data.response.txt_banner1 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_banner_1: `www.api3.digimovieplex.com/${res.data.response.txt_banner1}` },
                    ...
                    if (res.data.response.txt_banner2 !== '' && res.data.response.txt_banner2 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_banner_2: `www.api3.digimovieplex.com/${res.data.response.txt_banner2}` },
                    ...
                    if (res.data.response.txt_screenshot1 !== '' && res.data.response.txt_screenshot1 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_screenshot_1: `www.api3.digimovieplex.com/${res.data.response.txt_screenshot1}` },
                    ...
                    if (res.data.response.txt_screenshot2 !== '' && res.data.response.txt_screenshot2 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_screenshot_2: `www.api3.digimovieplex.com/${res.data.response.txt_screenshot2}` },
                    ...
                    if (res.data.response.txt_screenshot3 !== '' && res.data.response.txt_screenshot3 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_screenshot_3: `www.api3.digimovieplex.com/${res.data.response.txt_screenshot3}` },
                    ...
                    if (res.data.response.txt_screenshot4 !== '' && res.data.response.txt_screenshot4 !== null) {
                        this.setState({
                            repFile: { ...this.state.repFile, rep_screenshot_4: `www.api3.digimovieplex.com/${res.data.response.txt_screenshot4}` },
